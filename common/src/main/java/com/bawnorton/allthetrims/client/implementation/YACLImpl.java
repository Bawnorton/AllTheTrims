                                                          ...
                                                          .group(OptionGroup.createBuilder()
                                                                            ...
                                                                            .option(Option.<Boolean>createBuilder()
                                                                                          .description(OptionDescription.createBuilder()
                                                                                                                        .text(Text.translatable("yacl.allthetrims.description.debug1"), Text.translatable("yacl.allthetrims.description.debug2"), Text.translatable("yacl.allthetrims.description.debug3"))
                                                                                                                        .build())
